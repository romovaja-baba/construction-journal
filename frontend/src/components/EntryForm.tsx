...
import { FormAlert, FormField } from "./FormField";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormField label="Вид работ *" error={errors.work_type_id?.message}>
          <select {...register("work_type_id")} className="input-field">
        ...
        <div className="flex gap-2">
          ...
          <FormField label="Ед. *" error={errors.unit?.message} className="w-24">
        ...
        <FormField label="Исполнитель (ФИО) *" error={errors.executor_name?.message}>
          <input
            type="text"
        ...
        <div className="flex gap-2 border-t border-journal-border pt-4">
